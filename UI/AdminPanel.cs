...
namespace UI
{
    public partial class AdminPanel : Form
    {
        ...
        private void AdminPanel_Load(object sender, EventArgs e)
        {
            ...
            //Kategorilerim =ctm.ListBll();
            ClearAll();

            #region EpmployeeTable
        ...
        private void bttncategoryadd_Click(object sender, EventArgs e)
        {
            ...
            else if (Kategorilerim.FirstOrDefault(w => w.CategoryName == txtCatAdd.Text) == null)
            {
        ...
        {
            var obje = Kategorilerim.FirstOrDefault(w => w.CategoryName == cmbCatUpdt.SelectedItem.ToString());
            if (obje != null)
        ...
        {
            var obje = Kategorilerim.FirstOrDefault(w => w.CategoryName == cmbCatDlt.SelectedItem.ToString());
            if (obje != null)
        ...
        private void btnAddEmp_Click(object sender, EventArgs e)
        {
            ...
            {
                if (String.IsNullOrWhiteSpace(txtFirstNameAddEmp.Text) && String.IsNullOrWhiteSpace(txtLastNameAddEmp.Text) && String.IsNullOrWhiteSpace(txtAddTcEmp.Text) && String.IsNullOrWhiteSpace(txtUserNameEmp.Text) && String.IsNullOrWhiteSpace(txtPswEmp.Text))
                {
            ...
            {
                if (String.IsNullOrWhiteSpace(txtFirstNameAddEmp.Text) && String.IsNullOrEmpty(txtLastNameAddEmp.Text) && String.IsNullOrWhiteSpace(txtAddTcEmp.Text) && String.IsNullOrWhiteSpace(txtUserNameEmp.Text) && String.IsNullOrWhiteSpace(txtPswEmp.Text))
                {
                    MessageBox.Show("Employee name cannot be empty !");
                }
                else if (eml.ListBll().FirstOrDefault(w => w.FirstName == txtFirstNameAddEmp.Text && w.LastName == txtLastNameAddEmp.Text && w.TC == txtAddTcEmp.Text && w.UserName == txtUserNameEmp.Text && w.Password == txtPswEmp.Text) == null)
        ...
        {
            var em = eml.ListBll().FirstOrDefault(w=>w.IsManager==true);
